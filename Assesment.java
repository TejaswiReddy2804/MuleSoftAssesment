...
public class Assesment{
    public static void main(String[] args) throws SQLException {
        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/sys","root","tej123@");
        ...
        PreparedStatement pstmt2 = con.prepareStatement("SELECT * FROM MOVIES WHERE lead_actor =\"RAM CHARAN\"");
        ResultSet result2 = pstmt2.executeQuery();
        System.out.println("Display Rows Of Table Based On a Condition  : ");
        System.out.println("---------------------------");
        while (result2.next()){
